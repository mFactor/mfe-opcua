...
exports.standardUnits = {
  ...
  curiePerKilogram:     makeEUInformation("A42", "Ci/kg", "Curie per kilogram = 3,7E-10 Bq/kg"),
  cubicCentimetre:      makeEUInformation("CMQ", "cm^3",  "Cubic centimetre = 1E-6 m^3"),
  cubicCmPerSec:        makeEUInformation("2J", "cm^3/s", "Cubic centimetre per second"),
  cubicMetre:           makeEUInformation("MTQ", "m^3",   "Cubic metre"),
  cubicMetrePerHour:    makeEUInformation("MQH", "m^3",   "Cubic metre per hours = 2,777 78 x 10⁻⁴ m³/s"),
  degree:               makeEUInformation("DD",  "°",     "degree [unit of angle]"),
  degreeC:              makeEUInformation("CEL", "°C",    "degree Celsius"),
  degreeF:              makeEUInformation("FAH", "°F",    "degree Fahrenheit 9/5(°C) + 32°"),
  kelvin:               makeEUInformation("KEL", "K",     "degree Kelvin"),
  dotsPerInch:          makeEUInformation("E39", "dpi",   "dot per inch"),
  electronVolt:         makeEUInformation("A53", "eV",    "electron volt"),
  kiloElectronVolt:     makeEUInformation("B29", "keV",   "kilo electron volt"),
  megaElectronVolt:     makeEUInformation("B71", "MeV",   "mega electron volt"),
  ...
  kilopascal:           makeEUInformation("KPA", "kPa",   "kilo pascal = 1E3 pascal"),
  ...
  microGPerCubicM:      makeEUInformation("GQ",  "µg/m³", "10⁻⁹ kg/m³"),
  megawatt:             makeEUInformation("MAW", "MW",    "Mega Watt"),
  newton:               makeEUInformation("NEW", "N",     "Newton (kg x m)/s² "),
  ppb:                  makeEUInformation("61",  "ppb",   "A unit of proportion equal to 10⁻⁹."),
  ppm:                  makeEUInformation("59",  "ppm",   "A unit of proportion equal to 10⁻⁶."),
